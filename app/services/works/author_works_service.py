...
from app.schemas.works.work import BasicWorkInfoForAuthor, WorkSchema
...
class AuthorWorksService(BaseService):
    ...
    async def get_work(self) -> BasicWorkInfoForAuthor:
        ...
        work = WorkSchema.model_validate(my_work)
