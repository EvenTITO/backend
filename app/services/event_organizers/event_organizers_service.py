...
from app.exceptions.members.organizer.organizer_exceptions import ExpiredOrganizerInvitation, \
    NotExistPendingOrganizerInvitation
...
class EventOrganizersService(BaseService):
    ...
    async def get_all_organizers(self, event_id: str):
        organizers_chairs = await self.organizer_repository.get_all(event_id)
    ...
    async def accept_organizer_invitation(self, user_id: str, event_id: str):
