...
class EventInscriptionStorageService(StorageService):
    ...
    async def get_affiliation_upload_url(self, event_id: str, user_id: str, inscription_id: int) -> UploadURLSchema:
    ...
    async def get_payment_upload_url(self, event_id: str, user_id: str, inscription_id: str) -> UploadURLSchema:
        return await self.storage_client.generate_signed_upload_url(
            bucket_name=self.storage_settings.CERTIFICATES_BUCKET,
