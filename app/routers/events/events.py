...
from app.routers.events.members.reviewers import event_reviewers_router, event_works_reviewers_router
...
events_router.include_router(event_works_reviewers_router)
